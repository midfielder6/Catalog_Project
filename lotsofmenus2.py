...
from database_setup2 import Restaurant, Base, MenuItem, User
...
# create a user
User1 = User(name="Steve J", email="midflder3@gmail.com")

#Menu for UrbanBurger
restaurant1 = Restaurant(name = "Urban Burger", street = "150 Sutton Place", city = "Closter", zipcode = "07624", rtype = "Tavern")
...
restaurant2 = Restaurant(name = "Super Stir Fry", street = "324 Mountain Road", city = "Montclair", zipcode = "07042", rtype = "Fine Dining")
...
restaurant3 = Restaurant(name = "Panda Garden", street = "100 Route 34N", city = "Cedar Knolls", zipcode = "07927", rtype = "Breakfast-Lunch")
...
restaurant4 = Restaurant(name = "Thyme for That Vegetarian Cuisine ", street = "10 Market Street", city = "Hackensack", zipcode = "07602", rtype = "Fine Dining")
...
restaurant5 = Restaurant(name = "Tony\'s Bistro ", street = "1502 Arthur Ave.", city = "Bronx", zipcode = "10457", rtype = "Tavern")
...
#Menu for Andala's
restaurant6 = Restaurant(name = "Andala\'s", street = "1 Main Street", city = "Clifton", zipcode =" 07012", rtype = "Fine Dining")
...
restaurant7 = Restaurant(name = "Pista House ", street = "2305 Forham Road", city = "Bronx", zipcode = "10457", rtype = "Fine Dining")
...
menuItem6 = MenuItem(name = "Chicken65", description = "A deep fried chicken with authentic Indian species.", price = "$8.99", course = "Appetizer", restaurant = restaurant7)
