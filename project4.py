...
APPLICATION_NAME = "Restaurant Menu App 2"
...
def gconnect():
    ...
    # print 'User id is' +str(login_session['user_id'])
    # username = getUserID(login_session['username'])
    if user_id:
...
#    if request.method == 'POST':
        # add new field data to record
#        print "Start POST of New Restarant!!!!!"
#        newRestaurant = Restaurant(name = request.form['name'], street = request.form['street'],
#            city = request.form['city'], zipcode = request.form['zipcode'], rtype = request.form['rtype'],
#            user_id = login_session['gplus_id'])
#        session.add(newRestaurant)
#        flash('New Restaurant User %s Successfully Created' % newRestaurant.user_id)
#
#        session.commit()
#        return redirect(url_for('showRestaurants'))
#    else:
...
def newRestaurant():
    if request.method == 'POST':
        ...
        flash('New Restaurant By User %s Successfully Created' % newRestaurant.user_id)
        return redirect(url_for('showRestaurants'))
    else:
        return render_template('newRestaurant.html')
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        #debug code
        print editedRestaurant.user_id
    ...
    if request.method == 'POST':
        ...
        if request.form['rtype']:
            editedRestaurant.rtype = request.form['rtype']
